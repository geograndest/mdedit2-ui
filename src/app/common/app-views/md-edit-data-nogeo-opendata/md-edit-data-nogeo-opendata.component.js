import template from './md-edit-data-nogeo-opendata.html';

const mdEditDataNogeoOpendataController = class MdEditDataNogeoOpendataController {
    ...
    $onInit() {
        ...
        this.extentsFile = this.appConfig.views.mdEditDataNogeoOpendata.extentsFile;
...
export const mdEditDataNogeoOpendataComponent = {
    bindings: {
        appConfig: '<',
        appLocales: '<',
        mdEditLocales: '<',
    ...
    template: template,
    controller: mdEditDataNogeoOpendataController
};