import template from './md-edit-data-geo-opendata.html';

const mdEditDataGeoOpendataController = class MdEditDataGeoOpendataController {
    ...
    $onInit() {
        ...
        this.extentsFile = this.appConfig.views.mdEditDataGeoOpendata.extentsFile;
...
export const mdEditDataGeoOpendataComponent = {
    bindings: {
        appConfig: '<',
        appLocales: '<',
        mdEditLocales: '<',
    ...
    template: template,
    controller: mdEditDataGeoOpendataController
};