import template from './md-form-inspirecontacts.html';

const mdFormInspirecontactsController = class MdFormInspirecontactsController {
...
export const mdFormInspirecontactsComponent = {
    bindings: {
        lists: '<',
        md: '<',
        field: '<',
    ...
    template: template,
    controller: mdFormInspirecontactsController,
};