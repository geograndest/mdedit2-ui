import template from './md-form-inspirecontact.html';

const mdFormInspirecontactController = class MdFormInspirecontactController {
...
export const mdFormInspirecontactComponent = {
    bindings: {
        multi: '@',
        key: '@',
        contact: '<',
    ...
    template: template,
    controller: mdFormInspirecontactController,
};