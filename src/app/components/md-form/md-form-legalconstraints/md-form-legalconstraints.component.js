import template from "./md-form-legalconstraints.html";

const mdFormLegalconstraintsController = class MdFormLegalconstraintsController {
...
export const mdFormLegalconstraintsComponent = {
    ...
    template: template,
    controller: mdFormLegalconstraintsController
};